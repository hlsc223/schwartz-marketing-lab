...
tags:
  ...
  - Organic Traffic
  - AI Search
faqIntro: The findings above tend to prompt the same questions. Here's how we
  answer them.
faqs:
  - question: What does it mean that B2B organic traffic "split" in 2025?
    answer: S.LAB tracked 118 B2B SaaS companies across 10 verticals over an
      18-month window and found that organic traffic did not decline uniformly.
      Forty-seven percent of companies lost organic traffic, while 37% grew —
      often in the same categories and under the same search conditions. The
      research found that the structural properties of each company's content
      more consistently explained the split than category, domain authority, or
      publishing volume alone.
  - question: What is durable demand?
    answer: "Durable demand renews continuously because it ties to foundational
      ...
      audience itself regenerates. It contrasts with fragile demand: queries
      that an AI summary or search result can fully satisfy without requiring
      further engagement."
  - question: What does it mean when rankings and traffic decouple?
    answer: Rankings and traffic decouple when a page holds or improves its Google
      rankings while traffic falls sharply. This happens when AI Overviews or
      other search features answer the user’s question before they visit the
      page. One company in S.LAB’s research experienced this across more than 20
      high-ranking pages. When rankings and traffic separate, improving rankings
      alone doesn’t solve the problem because visibility is no longer the
      primary constraint.
  - question: Can B2B companies still grow organic traffic in the AI era?
    answer: "Yes. 37%of the 118 companies S.LAB tracked grew organic traffic during
      the study period, including while AI Overviews expanded significantly. The
      companies that grew shared a common characteristic: they built content
      that required continued engagement rather than one-time extraction. "
---
...
***[Check out the full report now. ](https://schwartzmarketinglab.com/playbooks/modern-organic-growth-playbook/)***
